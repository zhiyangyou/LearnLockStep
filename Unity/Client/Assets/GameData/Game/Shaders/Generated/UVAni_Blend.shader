...
Shader "TropicalStorm/UVAni_Blend"
{
	Properties {
		_1stColor("No.1颜色", Color) = (0.5, 0.5, 0.5, 0.5)
		_1stBright ("1st Bright ", Range(0.0,1.0)) = 1
	...
	//	Blend One One
	//	Blend SrcAlpha One       //源颜色 x 源通道  + 目标颜色  常用的add 模式
		Blend SrcAlpha OneMinusSrcAlpha  //源颜色 x 源通道 + 目标颜色 x (1 - 源通道)     alpha Blend
		...
		Pass {
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				o =(tex- _1stBright) * tex2 *  _AddBright;
