Shader "HeroGo/SimulatePBR/Tint_FadeOut" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
			...
			float gradualMT;
				...
				o.TintFactor = 1 - saturate(max(_ElapsedTime - _FadeInBegin, 0) / _FadeInLen);
                return o;
            }
		...
		// directionGradua---<
			...
			//--->	
				...
				finalColor = lerp(finalColor,_TintColor,_TintFactor);
                return fixed4(finalColor, i.TintFactor);
            }
            ENDCG
        }
    }
