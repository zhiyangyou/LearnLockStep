Shader "HeroGo/Cel/Surface/General_Rim_Flash"
{
	Properties
	{	    
...
//		wave += _Bias;
				...
				fixed4 col;
				float rimcol = 1.0 - saturate(dot(viewDir, i.worldNormal));
				float factor = pow(saturate(rimcol - _RimLightOffset), _RimLightPower) * i.TintFactor;
				col.rgb = finalColor.rgb * (1 - factor) + _RimLightColor.rgb * factor;
				col.a = 1;
