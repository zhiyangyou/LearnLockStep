Shader "HeroGo/Dissolution/Outline_Flash" {
    Properties {
...
////// Emissive:
				...
				float fresnel = 1.0 - saturate(dot(normalDirection, i.viewDirection));
				finalColor += pow(fresnel, 2) * outlineCol * 2;
