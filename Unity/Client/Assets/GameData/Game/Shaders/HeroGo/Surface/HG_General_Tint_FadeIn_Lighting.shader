...
Shader "HeroGo/Surface/General_Tint_FadeIn"
{
	Properties
	{
		...
		_FadeInBegin("Fade Out Begin Time",Range(0,3)) = 0.5
		_FadeInLen("Fade Out Time Length",Range(0,3)) = 0.5
