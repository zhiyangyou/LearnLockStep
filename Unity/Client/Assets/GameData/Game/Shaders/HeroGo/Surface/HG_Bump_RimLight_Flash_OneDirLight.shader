...
Shader "HeroGo/General/OneDirLight/Bumped_RimLight_Flash"
{
	Properties
	{
		...
		_RimLightColor("Rim Light Color",Color) = (1.0,1.0,0.0,1.0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag (v2f IN) : SV_Target
			{
				...
				half value = saturate(_ElapsedTime / _AnimTimeLen) * _RimLightPower;
				half factor = pow(rim, value);
